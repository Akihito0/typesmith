    ...
    >
      ...
      >
        ...
        <p className="mt-1 text-[13px] text-muted">
          Layouts for teams that present type systems to clients — all unlocked
          in the sidebar.
        </p>
        ...
        <div className="mt-5 rounded-md bg-surface px-3.5 py-3 text-[12px] leading-relaxed text-muted">
          There&apos;s nothing to buy — TypeSmith is free while in beta and every Pro
          layout above is already usable, no account required. Paid plans may
          come later; check the Docs link in the sidebar for progress.
        </div>
